...
class DB_Manager:
    ...
    def update_project_skill(self, project_id, old_skill_id, new_skill_id):
        sql = 'UPDATE project_skills SET skill_id = ? WHERE project_id = ? AND skill_id = ?'
        self.__executemany(sql, [(new_skill_id, project_id, old_skill_id)])
